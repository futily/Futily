# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-09-16 18:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ea_id', models.CharField(blank=True, max_length=255, null=True)),
                ('quality', models.CharField(choices=[('bronze', 'Bronze'), ('silver', 'Silver'), ('gold', 'Gold'), ('special', 'Special')], default='special', max_length=255)),
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packs.Packs')),
        ...
        migrations.AddField(
            model_name='pack',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packs.PackType'),
        ),
        migrations.AddField(
            model_name='pack',
            name='user',
