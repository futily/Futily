# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-15 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normal_types', futily.apps.fields.ChoiceArrayField(base_field=models.CharField(blank=True, choices=[('', ''), ('award_winner', 'Award winner'), ('bronze', 'Bronze'), ('confederation_champions_motm', 'Confederation champions motm'), ('fut_birthday', 'Fut birthday'), ('futties_winner', 'Futties winner'), ('gold', 'Gold'), ('gotm', 'Gotm'), ('halloween', 'Halloween'), ('imotm', 'Imotm'), ('legend', 'Legend'), ('motm', 'Motm'), ('movember', 'Movember'), ('ones_to_watch', 'Ones to watch'), ('pink', 'Pink'), ('purple', 'Purple'), ('rare_bronze', 'Rare bronze'), ('rare_gold', 'Rare gold'), ('rare_silver', 'Rare silver'), ('record_breaker', 'Record breaker'), ('sbc_base', 'Sbc base'), ('silver', 'Silver'), ('st_patricks', 'St patricks'), ('tots_bronze', 'Tots bronze'), ('tots_gold', 'Tots gold'), ('tots_silver', 'Tots silver'), ('totw_bronze', 'Totw bronze'), ('totw_gold', 'Totw gold'), ('totw_silver', 'Totw silver'), ('toty', 'Toty')], max_length=100, null=True), default=list, size=None)),
                ('normal_types_rating_min', models.PositiveIntegerField(default=75)),
                ('normal_types_rating_max', models.PositiveIntegerField(default=99)),
                ('normal_types_count', models.PositiveIntegerField(default=0)),
                ('rare_types', futily.apps.fields.ChoiceArrayField(base_field=models.CharField(blank=True, choices=[('', ''), ('award_winner', 'Award winner'), ('bronze', 'Bronze'), ('confederation_champions_motm', 'Confederation champions motm'), ('fut_birthday', 'Fut birthday'), ('futties_winner', 'Futties winner'), ('gold', 'Gold'), ('gotm', 'Gotm'), ('halloween', 'Halloween'), ('imotm', 'Imotm'), ('legend', 'Legend'), ('motm', 'Motm'), ('movember', 'Movember'), ('ones_to_watch', 'Ones to watch'), ('pink', 'Pink'), ('purple', 'Purple'), ('rare_bronze', 'Rare bronze'), ('rare_gold', 'Rare gold'), ('rare_silver', 'Rare silver'), ('record_breaker', 'Record breaker'), ('sbc_base', 'Sbc base'), ('silver', 'Silver'), ('st_patricks', 'St patricks'), ('tots_bronze', 'Tots bronze'), ('tots_gold', 'Tots gold'), ('tots_silver', 'Tots silver'), ('totw_bronze', 'Totw bronze'), ('totw_gold', 'Totw gold'), ('totw_silver', 'Totw silver'), ('toty', 'Toty')], max_length=100, null=True), default=list, size=None)),
                ('rare_types_rating_min', models.PositiveIntegerField(default=75)),
                ('rare_types_rating_max', models.PositiveIntegerField(default=99)),
                ('rare_types_count', models.PositiveIntegerField(default=0)),
                ('special_types', futily.apps.fields.ChoiceArrayField(base_field=models.CharField(blank=True, choices=[('', ''), ('award_winner', 'Award winner'), ('bronze', 'Bronze'), ('confederation_champions_motm', 'Confederation champions motm'), ('fut_birthday', 'Fut birthday'), ('futties_winner', 'Futties winner'), ('gold', 'Gold'), ('gotm', 'Gotm'), ('halloween', 'Halloween'), ('imotm', 'Imotm'), ('legend', 'Legend'), ('motm', 'Motm'), ('movember', 'Movember'), ('ones_to_watch', 'Ones to watch'), ('pink', 'Pink'), ('purple', 'Purple'), ('rare_bronze', 'Rare bronze'), ('rare_gold', 'Rare gold'), ('rare_silver', 'Rare silver'), ('record_breaker', 'Record breaker'), ('sbc_base', 'Sbc base'), ('silver', 'Silver'), ('st_patricks', 'St patricks'), ('tots_bronze', 'Tots bronze'), ('tots_gold', 'Tots gold'), ('tots_silver', 'Tots silver'), ('totw_bronze', 'Totw bronze'), ('totw_gold', 'Totw gold'), ('totw_silver', 'Totw silver'), ('toty', 'Toty')], max_length=100, null=True), default=list, size=None)),
                ('special_types_rating_min', models.PositiveIntegerField(default=75)),
                ('special_types_rating_max', models.PositiveIntegerField(default=99)),
                ('special_types_count', models.PositiveIntegerField(default=0)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ...
                ('page', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='packs.Packs')),
        ...
        migrations.AddField(
            model_name='pack',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packs.Type'),
        ),
        migrations.AddField(
            model_name='pack',
            name='user',
