    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.AddField(
            model_name='squad',
            name='page',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='squads.Squads'),
        ),
        migrations.AddField(
            model_name='squad',
            name='players',
            field=models.ManyToManyField(blank=True, through='squads.SquadPlayer', to='players.Player'),
        ),
        migrations.AddField(
            model_name='squad',
            name='twitter_image',
        ...
        migrations.AlterUniqueTogether(
            name='squad',
            unique_together=set([('title', 'is_special')]),
        ),
    ]
