...
from .views import CommentFeedback, CommentList, dislike, like
...
urlpatterns = [
    ...
    url(r'^like/(\d+)/$', like, name='comments-xtd-like'),
    url(r'^liked/$', views.like_done, name='comments-xtd-like-done'),
    url(r'^dislike/(\d+)/$', dislike, name='comments-xtd-dislike'),
    ...
    url(r'^api/feedback/$', CommentFeedback.as_view(),
